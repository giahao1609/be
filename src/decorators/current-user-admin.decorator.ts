...
import { JwtUserInstanceAdminPipe } from 'src/pipes/jwt-user-instance-admin.pipe';
...
export const CurrentUserAdmin = (additionalOptions?: any) =>
  JwtUser(additionalOptions, JwtUserInstanceAdminPipe);
